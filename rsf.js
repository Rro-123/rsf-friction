...
(function (root, factory) {
   ...
   */
  var materials = {
    granite:   { name: '花岗岩（岩石）',        mu: 0.60, muS: 0.65, mu0: 0.60, a: 0.008, b: 0.012, Dc: 5e-6, V0: 1e-6 },
    sandstone: { name: '砂岩（岩石）',          mu: 0.55, muS: 0.60, mu0: 0.60, a: 0.005, b: 0.010, Dc: 1e-5, V0: 1e-6 },
    limestone: { name: '石灰岩（岩石）',        mu: 0.50, muS: 0.55, mu0: 0.55, a: 0.006, b: 0.009, Dc: 1e-5, V0: 1e-6 },
    steel:     { name: '钢-钢（干）',           mu: 0.42, muS: 0.60 },
    aluminum:  { name: '铝-钢（干）',           mu: 0.45, muS: 0.55 },
    castiron:  { name: '铸铁-铸铁（干）',       mu: 0.20, muS: 0.30 },
    glass:     { name: '玻璃-玻璃（干）',       mu: 0.90, muS: 0.95 },
    wood:      { name: '木材-木材',             mu: 0.30, muS: 0.40 },
    rubber:    { name: '橡胶-混凝土（干）',     mu: 0.80, muS: 0.90 },
    ptfe:      { name: '聚四氟乙烯(PTFE)-钢',   mu: 0.05, muS: 0.06 },
    ice:       { name: '冰-钢',                 mu: 0.03, muS: 0.10 }
  };
