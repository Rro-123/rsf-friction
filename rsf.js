...
(function (root, factory) {
  ...
  var materials = {
    ...
    aluminum_steel: { name: '铝-钢（干）',         material1: '铝',     material2: '钢',     category: 'metal',   mu: 0.45, muS: 0.55 },
    castiron:     { name: '铸铁-铸铁（干）',     material1: '铸铁',   material2: '铸铁',   category: 'metal',   mu: 0.20, muS: 0.30 },
    copper_steel:  { name: '铜-钢（干）',         material1: '铜',     material2: '钢',     category: 'metal',   mu: 0.36, muS: 0.53 },
    brass_steel:   { name: '黄铜-钢（干）',       material1: '黄铜',   material2: '钢',     category: 'metal',   mu: 0.44, muS: 0.51 },
    bronze_steel:  { name: '青铜-钢（干）',       material1: '青铜',   material2: '钢',     category: 'metal',   mu: 0.20, muS: 0.25 },
    nickel_steel:  { name: '镍-钢（干）',         material1: '镍',     material2: '钢',     category: 'metal',   mu: 0.35, muS: 0.50 },
    ...
    lead_steel:    { name: '铅-钢（干）',         material1: '铅',     material2: '钢',     category: 'metal',   mu: 0.50, muS: 0.90 },
    zinc_steel:    { name: '锌-钢（干）',         material1: '锌',     material2: '钢',     category: 'metal',   mu: 0.21, muS: 0.85 },
    stainless_steel: { name: '不锈钢-不锈钢（干）', material1: '不锈钢', material2: '不锈钢', category: 'metal', mu: 0.50, muS: 0.70 },
    tin_steel:     { name: '锡-钢（干）',         material1: '锡',     material2: '钢',     category: 'metal',   mu: 0.40, muS: 0.60 },
    ...
    tungsten_steel: { name: '碳化钨-钢（干）',     material1: '碳化钨', material2: '钢',     category: 'metal',   mu: 0.45, muS: 0.55 },
    ...
    pvc:           { name: 'PVC-PVC',             material1: '聚氯乙烯（PVC）', material2: '聚氯乙烯（PVC）', category: 'polymer', mu: 0.40, muS: 0.50 },
    ...
    ptfe:          { name: 'PTFE-PTFE',           material1: '聚四氟乙烯（PTFE）', material2: '聚四氟乙烯（PTFE）', category: 'polymer', mu: 0.04, muS: 0.04 },
    ...
    ceramic_steel: { name: '陶瓷(氧化铝)-钢',     material1: '陶瓷（氧化铝）', material2: '钢', category: 'other', mu: 0.45, muS: 0.55 },
    tire_asphalt:  { name: '轮胎-沥青路面（干）', material1: '橡胶轮胎', material2: '沥青路面', category: 'other', mu: 0.80, muS: 0.90, note: '经典橡胶轮胎-沥青路面数据' },
    brick_wood:    { name: '砖-木材（干）',       material1: '砖',     material2: '木材',   category: 'other',   mu: 0.50, muS: 0.60 },
    cork_steel:    { name: '软木-钢',             material1: '软木',   material2: '钢',     category: 'other',   mu: 0.30, muS: 0.35 },
    felt_steel:    { name: '毛毡-钢',             material1: '毛毡',   material2: '钢',     category: 'other',   mu: 0.25, muS: 0.30 },
